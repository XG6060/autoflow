...
export default function RegisterPage() {
  const { register, user, token, loading, error, clearError } = useAuthStore();
    ...
    <div className="flex min-h-screen items-center justify-center bg-surface-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 rounded-2xl border border-surface-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-1 text-sm text-surface-500">Start automating in minutes</p>
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-4">
            <div>
              ...
              <div className="relative mt-1.5">
                <UserIcon className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-surface-400" />
                <input
                  id="name"
                  type="text"
                  value={name}
